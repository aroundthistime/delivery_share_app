...
export default ({ navigation }) => {
    ...
    return <View>
        ...
        {currentKeyword !== "" ? (
            <ScrollView>
                <SearchResultBrief>
                    {currentKeyword} <Text style={{ color: "rgba(0,0,0,0.33)" }}>검색결과</Text>  -  {3}개</SearchResultBrief>
                <FlatList
                    data={[FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT, FAKE_RESTAURANT]}
