...
export default ({navigation, route}) => {
    ...
    return <Container>
        ...
        <FlatList
            data={[1, 2, 3, 4, 5, 6, 7]}
            renderItem={(item)=><RestaurantListBar {...FAKE_RESTAURANT} onPress={()=>1}/>}
            style={{
