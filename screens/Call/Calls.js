...
const dummyCallsData = [
  {
    ...
    brandName: "스타벅스",
    menus: [
      { name: "아이스 아메리카노", price: 25000 },
      { name: "핫 아메리카노", price: 10000 },
      { name: "바닐라 아메리카노", price: 6000 },
    ],
    dist: 10,
  },
  {
  ...
  },
  {
    ...
    brandName: "할리스커피",
    menus: [
      { name: "딸기 아메리카노", price: 4500 },
      { name: "버섯 아메리카노", price: 4500 },
    ],
    dist: 60,
  },
  {
    ...
    userId: "보라개나리",
    brandName: "이디야",
    menus: [{ name: "버섯 아메리카노", price: 4500 }],
    dist: 70,
  },
  {
    image:
